...
const Card = ({ name, data }) => {
    ...
    const splitText1 = data.description5.split("/endline");
    const splitText2 = data.description6.split("/endline");
    const splitText3 = data.description7.split("/endline");
    const splitText4 = data.description8.split("/endline");
    const splitText5 = data.description9.split("/endline");
    const splitText6 = data.description10.split("/endline");
    const splitText7 = data.field15.split("/endline");
    const splitText8 = data.field16.split("/endline");
    const splitText9 = data.field17.split("/endline");
                ...
                <div className="mx-auto mb-12">
                    <div className="degital-marketing-heading text-center">
                        <div className="section-sub-title pb-4">
                            <h4 className="primary-heading">{highlightText2(data.field4)}</h4>
                        </div>
                        <div>
                            <h2 className="font-bold mt-2 -mb-1 text-xl">{data.field5}</h2>
                        </div>
                    </div>
                </div>
                <motion.div variants={variants} initial="hidden" whileInView="show" className="grid grid-cols-1 md:grid-cols-3 gap-8 ">
                    <motion.div variants={items}>
                        <div className="service-card-five-purple text-center">
                            ...
                            <div className="card-title">
                                <h3 class="pb-6 text-xl font-bold">{data.field6}</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                {splitText1[0]}<br />
                                <span className="mt-4 block">{splitText1[1]}</span>
                            </p>
                        </div>
                    </motion.div>
                    ...
                    <motion.div variants={items}>
                        <div className="service-card-five-red text-center">
                            ...
                            <div className="card-title">
                                <h3 class="pb-6 text-xl font-bold">{data.field7}</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                {splitText2[0]} <br />
                    ...
                    <motion.div variants={items}>
                        <div className="service-card-five-green text-center">
                            ...
                            <div className="card-title">
                                <h3 class="pb-6 text-xl font-bold">{data.field8}</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                {splitText3[0]} <br />
                    ...
                    <motion.div variants={items}>
                        <div className="service-card-five-blue text-center">
                            ...
                            <div className="card-title">
                                <h3 class="pb-6 text-xl font-bold">{data.field9}</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                {splitText4[0]} <br />
                    ...
                    <motion.div variants={items}>
                        <div className="service-card-five-pink text-center">
                            ...
                            <div className="card-title">
                                <h3 className="pb-6 text-xl font-bold">{data.field11}</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                {splitText6[0]} <br />
                    ...
                    <motion.div variants={items}>
                        <div className={`service-card-five-purple text-center  ${splitText7[0] && data.field12 ? 'visible' : 'hidden'}`}>
                            <div className="svg-purple flex items-center justify-center mb-6">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    id="outline"
                            ...
                            <div className="card-title">
                                <h3 class="pb-6 text-xl font-bold">{data.field12}</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                {splitText7[0]}<br />
                                <span className="mt-4 block">{splitText7[1]}</span>
                            </p>
                        </div>
                    </motion.div>

                    <motion.div variants={items}>
                        <div className={`service-card-five-red text-center  ${splitText8[0] && data.field13 ? 'visible' : 'hidden'}`}>
                            <div className="svg-red flex items-center justify-center mb-6">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    x="0px"
                            ...
                            <div className="card-title">
                                <h3 class="pb-6 text-xl font-bold">{data.field13}</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                {splitText8[0]} <br />
                                <span className="mt-4 block">{splitText8[1]}</span>
                            </p>
                        </div>
                    </motion.div>

                    <motion.div variants={items}>
                        <div className={`service-card-five-green text-center ${splitText9[0] && data.field14 ? 'visible' : 'hidden'}`}>
                            <div className="svg-green flex items-center justify-center mb-6">
                                <svg
                                    id="Capa_1"
                                    enableBackground="new 0 0 512 512"
                            ...
                            <div className="card-title">
                                <h3 class="pb-6 text-xl font-bold">{data.field14}</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                {splitText9[0]} <br />
                                <span className="mt-4 block">{splitText9[1]}</span>
                            </p>
...
const HighEdu = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/higher-education/6672fe674b95d26ec6716fd2`);
                if (!response.ok) {
    ...
    return (
        <PageWrapper>
            <HigherEducation data={data} />
            <HigherEducationServices data={data} />
            <Card name={"Higher Education"} data={data} />
            <Why />
