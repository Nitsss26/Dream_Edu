...
import HigherEducationServices from "@/components/HigherEducation/HigherEducationFeatures";
import Why from '@/components/Why';

// const metadata = {
//     title: 'Dream Education/ Higher Level Education',
...
const Card = ({ name }) => {
    return (
        <section className="py-16 md:py-20 justify-center items-center bg-slate-100">
            <div className="app__container md:-mt-7">
                <div className="mx-auto mb-12">
                    <div className="degital-marketing-heading text-center">
                        ...
                        <div>
                            <h2 className="font-bold mt-2 -mb-1 text-xl">How We Help You With Our Higher Education Service</h2>
                        </div>
                    </div>
                </div>
                <motion.div variants={variants} initial="hidden" whileInView="show" className="grid grid-cols-1 md:grid-cols-3 gap-8 ">
                    <motion.div variants={items}>
                        <div className="service-card-five-purple text-center">
                            ...
                            <div className="card-title">
                                <h3 class="pb-6 text-xl font-bold">STEM Curriculum Development</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                Develop engaging curriculum that sparks curiosity, builds resilience and love for learning <br />
                                <span className="mt-4 block">Transform STEM Education with carefully crafted curriculum, designed to inspire students and encourage exploration for career path.</span>
                            </p>
                        </div>
                    </motion.div>
                    ...
                    <motion.div variants={items}>
                        <div className="service-card-five-red text-center">
                            ...
                            <div className="card-title">
                                <h3 class="pb-6 text-xl font-bold">Study Material Development</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                Create engaging and informative materials tailored to diverse learning needs <br />
                                <span className="mt-4 block">Enhancing educational experiences with comprehensive content development services, inspiring minds and facilitating effective learning.</span>
                            </p>
                        </div>
                    </motion.div>
                    ...
                    <motion.div variants={items}>
                        <div className="service-card-five-green text-center">
                            ...
                            <div className="card-title">
                                <h3 class="pb-6 text-xl font-bold">Fact Checking Services</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                Provide reliable and thorough fact-checking to ensure accuracy and credibility <br />
                                <span className="mt-4 block">Upholding the highest standards of accuracy and trustworthiness with our fact-checking expertise, fostering confidence in your content.</span>
                            </p>
                    ...
                    <motion.div variants={items}>
                        <div className="service-card-five-blue text-center">
                            <div className="svg-blue flex items-center justify-center mb-6">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    id="outline"
                                    viewBox="0 0 512 512"
                            ...
                            <div className="card-title">
                                <h3 class="pb-6 text-xl font-bold">Professional Proofreading</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                Ensure error-free, polished, and credible written materials <br />
                                <span className="mt-4 block">Make a great impression with our professional proofreading services, enhancing the clarity and credibility of your content.</span>
                            </p>
                        </div>
                    </motion.div>
                    ...
                    <motion.div variants={items}>
                        <div className="service-card-five text-center">
                            ...
                            <div className="card-title">
                                <h3 className="pb-6 text-xl font-bold">Type Setting</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                Present content in a clear, readable, and visually appealing format <br />
                                <span className="mt-4 block">Transform your content into polished publications with our precise typesetting services, ensuring readability and aesthetic appeal.</span>
                            </p>
                    ...
                    <motion.div variants={items}>
                        <div className="service-card-five-pink text-center">
                            <div className="svg-pink flex items-center justify-center mb-6">
                                <svg
                                    id="Capa_1"
                                    enableBackground="new 0 0 512 512"
                                    height="100"
                            ...
                            <div className="card-title">
                                <h3 className="pb-6 text-xl font-bold">Curriculum Development</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                Design dynamic, engaging, and adaptable learning programs <br />
                                <span className="mt-4 block">Shape the future of education with our tailored curriculum development services, providing a solid foundation for learning and growth.</span>
                            </p>
