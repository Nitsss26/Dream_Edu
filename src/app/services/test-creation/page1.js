...
const Card = ({ name, data }) => {
    ...
    const splitText4 = data.description7.split("/endline");
    const splitText5 = data.description8.split("/endline")
    const splitText6 = data.description9.split("/endline")

    return (
        <section className="py-16 md:py-20 bg-slate-100">
            <div className="app__container -mt-7 lg:px-10 xl:px-0">
                <div className="mx-auto mb-12">
                    <div className="degital-marketing-heading text-center">
                        <div className="section-sub-title pb-4">
                            <h4 className="primary-heading">{highlightText(data.field3)}</h4>
                        </div>
                        <div>
                            <h2 className="font-bold mt-2 -mb-1 text-xl">{data.field4}</h2>
                        </div>
                    </div>
                </div>
                <motion.div variants={variants} initial="hidden" whileInView="show" className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <motion.div variants={items}>
                        <div className="service-card-five-purple text-center">
                            <div className="svg-purple flex items-center justify-center mb-6">
                                <svg
                            ...
                            <div className="card-title">
                                <h3 className="pb-6 text-xl font-bold">{data.field5}</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                {splitText[0]}<br />
                                <span className="mt-4 block">{splitText[1]}</span>
                            </p>
                        </div>
                    </motion.div>

                    <motion.div variants={items}>
                        <div className="service-card-five-red text-center">
                            <div className="svg-red flex items-center justify-center mb-6">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    x="0px"
                                    y="0px"
                            ...
                            <div className="card-title">
                                <h3 className="pb-6 text-xl font-bold">{data.field6}</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                {splitText2[0]}<br />
                                <span className="mt-4 block">{splitText2[1]}</span>
                            </p>
                    ...
                    <motion.div variants={items}>
                        <div className="service-card-five-green text-center">
                            <div className="svg-green flex items-center justify-center mb-6">
                                <svg
                                    id="Capa_1"
                            ...
                            <div className="card-title">
                                <h3 className="pb-6 text-xl font-bold">{data.field7}</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                {splitText3[0]} <br />
                                <span className="mt-4 block">{splitText3[1]}</span>
                            </p>

                        </div>
                    </motion.div>

                    <motion.div variants={items} className={`${splitText4[0] && data.field8 ? 'visible' : 'hidden'}`} >
                        <div className="service-card-five-purple text-center">
                            <div className="svg-purple flex items-center justify-center mb-6">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div className="card-title">
                                <h3 className="pb-6 text-xl font-bold">{data.field8}</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                {splitText4[0]}<br />
                                <span className="mt-4 block">{splitText4[1]}</span>
                            </p>
                        </div>
                    </motion.div>

                    <motion.div variants={items} className={`${splitText5[0] && data.field9 ? 'visible' : 'hidden'}`}>
                        <div className="service-card-five-red text-center">
                            <div className="svg-red flex items-center justify-center mb-6">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div className="card-title">
                                <h3 className="pb-6 text-xl font-bold">{data.field9}</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                {splitText5[0]}<br />
                                <span className="mt-4 block">{splitText5[1]}</span>
                            </p>
                    ...
                    <motion.div variants={items} className={`${splitText4[0] && data.field8 ? 'visible' : 'hidden'}`}>
                        <div className="service-card-five-green text-center">
                            ...
                            <div className="card-title">
                                <h3 className="pb-6 text-xl font-bold">{data.field10}</h3>
                            </div>
                            <p className='app__text justify-center font-semibold'>
                                {splitText6[0]} <br />
                                <span className="mt-4 block">{splitText6[1]}</span>
                            </p>
...
const SocialMarketing = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/test-creation/6670c6c5d7d9fb32f2e5d3a2`);
                if (!response.ok) {
    ...
    const sections = [
        {
            section: <NeedService data={data} />
        },
        {
            section: <Social data={data} />
        },
        {
            section: <Card name={"Social Marketing"} data={data} />
        }, {
            section: <Why />
        },
        {
...
//   title: 'Dream Education / Test Creation',
...
//                         </div>
//                         <div>
//                             <h2 className="font-bold mt-2 -mb-1 text-xl">How We Help You With Our Test Creation</h2>
//                         </div>
//                     </div>
//                 </div>
//                 <motion.div variants={variants} initial="hidden" whileInView="show" className="grid grid-cols-1 md:grid-cols-3 gap-8">
...
//                             </div>
//                             <div className="card-title">
//                                 <h3 className="pb-6 text-xl font-bold">Test Series Creation</h3>
//                             </div>
//                             <p className='app__text justify-center font-semibold'>
//                                 Personalized Test Series Development, Subject-specific Assessments, and Progress Tracking <br />
//                                 <span className="mt-4 block">Tailored to individual needs, our test series include subject-specific assessments and advanced progress tracking features to monitor performance and enhance learning outcomes.</span>
//                             </p>
//                         </div>
//                     </motion.div>
...
//                             </div>
//                             <div className="card-title">
//                                 <h3 className="pb-6 text-xl font-bold">Mock Test Creation</h3>
//                             </div>
//                             <p className='app__text justify-center font-semibold'>
//                                 Custom-made Test Papers, Timed Assessments, and Simulation Exercises <br />
//                                 <span className="mt-4 block">Designed for practical readiness, our custom-made test papers, timed assessments, and simulation exercises ensure thorough preparation, empowering students with the necessary skills for exam success.</span>
//                             </p>
...
//                             </div>
//                             <div className="card-title">
//                                 <h3 className="pb-6 text-xl font-bold">Online Assessment Platform</h3>
//                             </div>
//                             <p className='app__text justify-center font-semibold'>
//                                 Interactive Online Assessment Platform, Real-time Feedback, and Performance Analysis <br />
//                                 <span className="mt-4 block">Offering an interactive online assessment platform, real-time feedback, and detailed performance analysis, we provide students with a dynamic learning experience to improve performance.</span>
//                             </p>
