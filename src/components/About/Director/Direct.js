...
//                             <div className="flex-1 md:ms-9 lg:hidden xs:me-0 lg:-me-8 lg:-pr-5 xs:pr-0 pb-10 lg:pb-0 ">
            ...
            <div className="mx-0 lg:mx-auto lg:ms-5 xl:ms-40 max-w-7xl md:p-12 lg:px-1 z-2">
                <div className="flex items-left sm:ms-2 justify-between md:mr-4">
                    <motion.div
                        ...
                        transition={{ delay: 0.25 }}
                        className="flex-1">
                        <h1 className="text-6xl md:text-3xl lg:text-6xl font-extrabold mb-3 capitalize xs:text-center lg:text-start">
                            {aboutData.title}
                        </h1><br />
                        <p className="xl:text-2xl xs:text-lg xs:font-bold lg:text-lg md:text-2xl mb-12 md:font-bold lg:font-bold">
                        ...
                        <div className="mt-5 flex flex-col lg:flex-row gap-5">
                            <div className="flex-1 md:ms-9 lg:hidden xs:me-0 lg:-me-8 lg:-pr-5 xs:pr-0 pb-10 lg:pb-0 ">
                                <img
                                    src={aboutData.image1 || '/path/to/director.jpg'}
                                    alt="dm"
                                />

                            </div>
                            <Link href="/team" className="primary-btn mt-5 shadow-lg xs:hidden lg:block ">Learn More</Link>
                            <h2 className="md:text-xl lg:text-lg xl:ms-40 lg:ms-40 xs:text-center">
                                {aboutData.field1} {aboutData.field2} {aboutData.field3}<br /><span className="mt-1 not-italic font-bold text-2xl">{aboutData.description3}</span>
                            </h2>
                            <Link href="/team" className="primary-btn mt-5 shadow-lg lg:hidden xs:mx-16 md:mx-48">Learn More</Link>
                        </div>
                    </motion.div>
